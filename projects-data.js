...
const PROJECTS_DATA = {
    ...
    'wall-segmentation': {
        ...
        description: 'Training Mask R-CNN to detect and segment walls in floorplan images. AI approach for architectural image analysis.',
    ...
    'motion-detection': {
        id: 'motion-detection',
        title: 'Motion Detection using Bg Subtraction Techniques',
        ...
        tags: ['Computer Vision', 'Motion Detection', 'OpenCV', 'Bg Subtraction'],
        date: 'December 2023',
